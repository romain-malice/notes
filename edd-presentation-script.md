...
4. Distribution grids give access to electricity directly to industries, or to homes and businesses, which are supplied through local distribution networks at lower voltages (220V)[^1][^3]

## What makes a good DN
%%
...
As seen previously, the power generated by PV penetrates the grid through AC voltages.
These voltages (power flows) interfere with the power flow controlled by the DNO, and can create uncertainties regarding the voltages and the frequency of the electricity distributed to the users.
